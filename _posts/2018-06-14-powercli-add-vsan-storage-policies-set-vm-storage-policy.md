---
ID: 414
post_title: 'PowerCLI &#8211; Add vSAN Storage Policies and Set Virtual Machine Storage Policy'
author: Ricardo Adao
post_excerpt: ""
layout: posts
permalink: >
  https://vrandombites.co.uk/2018/06/coding/powercli/powercli-add-vsan-storage-policies-set-vm-storage-policy/
published: true
post_date: 2018-06-14 02:33:26
---
There are multiple ways of adding extra storage policies and apply them to multiple <em>virtual machines</em> and plenty of <em>VMware</em> documentation and others to show how to do it.

But to reduce risk and minimize configuration drift, typically scripting/automating is the way to achieve that.

Hence we will try to quickly describe how to leverage some of the <em>VMware PowerCLI cmdlets</em> that can do this job for us.

And the better way of doing is using an example taken from our experience.

Our <strong>scenario </strong>is:
<ul>
