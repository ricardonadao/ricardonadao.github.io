...
(function($) {
    ...
    $("#comment-form").submit(function() {
      ...
      $("#comment-form-submit").html(
        '<svg class="icon spin"><use xlink:href="/assets/icons/loading.svg"></use></svg> Loading...'
      );
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          showAlert(
            '<strong>Thanks for your comment!</strong> It is <a href="https://github.com/ricardonadao/ricardonadao.github.io/pulls">currently pending</a> and will show on the site once approved.'
          );
        },
        error: function(err) {
          console.log(err);
